...
class DataPreprocessor:
    ...
    def save_processed_data(self, features_processed: np.ndarray, y: pd.Series, 
        ...
        features_path = str(self.output_dir / "preprocessing_features_processed.npy")
        labels_path = str(self.output_dir / "preprocessing_feature_labels.csv")
...
def run_data_ingestion_and_processing(raw_filename: str, clean_filename: str, 
    ...
    with mlflow.start_run(run_name="Preprocessing Pipeline") as run:
        ...
        # Save processed data
        features_path, labels_path, clean_path = preprocessor.save_processed_data(
